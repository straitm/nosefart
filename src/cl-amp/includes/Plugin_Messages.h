...
#define CLAMP_MSG_ADD			902		// Add a SongId to get the new entry inserted before that song
	...
	#define CLAMP_NOAUTOSAVE	"NoAutoSave"	// Boolean
	#define CLAMP_RECURSELIMIT	"RecLimit"		// Int16
	#define CLAMP_NOPLAYLISTS	"NoPL"			// Boolean
	#define CLAMP_NOFILES		"NoFiles"		// Boolean
